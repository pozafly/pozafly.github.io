...
![kakao](https://user-images.githubusercontent.com/59427983/82632092-3a61b080-9c32-11ea-9f27-095caa82282e.png)
...
카카오 API를 다룬다는게 매우 흥미로웠고, 다음에 정식으로 어떤 서비를 맡게되면 카카오 로그인 기능을 이용해서 로그인을 편하게 할 수 있는 시스템을 만들어보고 싶다. 아마 변수처리 부분은 같지않을까.😊
