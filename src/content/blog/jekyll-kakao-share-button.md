...
tags:
  - Blog
image: ../img/blog/jekyll-kakao-share-button/main.png
...
![kakao-share-button.png](../img/blog/jekyll-kakao-share-button/kakao-share-button.png)
...
![kakao-developers-register1](../img/blog/jekyll-kakao-share-button/kakao-developers-register1.png)
...
![kakao-developers-register2](../img/blog/jekyll-kakao-share-button/kakao-developers-register2.png)
...
![kakao-custom-share1](../img/blog/jekyll-kakao-share-button/kakao-custom-share1.png)

이것과 같이 사진과 함께 글과 버튼을 커스텀하기 위해서는 이 템플릿이 필요하다. 템플릿 만들기를 클릭하고 FEED, LIST, COMMERCE 3가지 템플릿이 나오는데 우리는 `FEED`를 선택해보자.

![kakao-id-confirm](../img/blog/jekyll-kakao-share-button/kakao-id-confirm.png)

상단의 APP 쪽 ID 가 아니라 화살표로 되어있는 밑에 부분 ID를 메모장에 또 기록해두고, 템플릿 설명을 아무거나 적고, 사용 목적으로 `카카오링크/나에게 보내기` 부분에 체크한 후 밑으로 내려가보자.

![kakao-custom-share2](../img/blog/jekyll-kakao-share-button/kakao-custom-share2.png)
...
![kakao-custom-share3](../img/blog/jekyll-kakao-share-button/kakao-custom-share3.png)
...
![kakao-login-button](../img/blog/jekyll-kakao-share-button/kakao-login-button.png)
...
![kakao-share-button-complete](../img/blog/jekyll-kakao-share-button/kakao-share-button-complete.png)
...
![kakao-button-attach](../img/blog/jekyll-kakao-share-button/kakao-button-attach.png)
