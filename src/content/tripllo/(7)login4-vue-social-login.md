...
image: ../img/tripllo/(7)login4-vue-social-login/main.jpeg
...
![social-login-buttons](<../img/tripllo/(7)login4-vue-social-login/social-login-buttons.png>)

## 소셜 로그인

- 소셜로그인 프로세스

![social-login-process](<../img/tripllo/(7)login4-vue-social-login/social-login-process.jpeg>)
...
![facebook-development1](<../img/tripllo/(7)login4-vue-social-login/facebook-development1.png>)

그리고 표시할 앱 이름에 편의에 맞게 이름을 정해준뒤 앱 만들기를 클릭하자.

![facebook-development2](<../img/tripllo/(7)login4-vue-social-login/facebook-development2.png>)

그러면 아래와 같이 앱에 제품을 추가할 수 있는 곳이 나온다. 여기서 Facebook 로그인 부분에 설정을 눌러주자.

![facebook-development3](<../img/tripllo/(7)login4-vue-social-login/facebook-development3.png>)

그리고, 우리는 웹에서 사용할 것이므로 웹을 선택해주자. 우선 local 환경에서 볼 것이기 때문에 http://localhost:8080 포트까지 입력.

![facebook-development4](<../img/tripllo/(7)login4-vue-social-login/facebook-development4.png>)

save를 누르고 다음을 누르면, JavaScript 용 Facebook SDK 설정 코드가 나오는데 해당 코드를 복사해둔다.

그리고 왼쪽 상단 탭에 보면 앱 ID 란이 있다 이녀석도 복사해두자.

![facebook-development5](<../img/tripllo/(7)login4-vue-social-login/facebook-development5.png>)
...
※ 아참, 그리고 자꾸 까먹는거.. env 파일에 넣으면 서버를 다시 껐다 켜주지 않으면 undifined 가 뜬다는 것. 그리고 init() 메서드를 실행하면 아래와 같이 FB.init() 에 AppId를 먼저 입력해야한다고 나올 것이다.

![devtool-error](<../img/tripllo/(7)login4-vue-social-login/devtool-error.png>)
...
![kakao-development1](<../img/tripllo/(7)login4-vue-social-login/kakao-development1.png>)

사진과 같이 입력해주고 들어가보자. 가장 먼저 뜨는 것은 앱키에 대한 부분이다. `JavaScript 키` 만 복사해두자. 이것도 페이스북과 마찬가지로 env 파일에 등록해줄것이다.

![kakao-development2](<../img/tripllo/(7)login4-vue-social-login/kakao-development2.png>)
...
![unauthorized-error](<../img/tripllo/(7)login4-vue-social-login/unauthorized-error.png>)
...
![kakao-development3](<../img/tripllo/(7)login4-vue-social-login/kakao-development3.png>)

그리고 동의 화면 미리보기를 눌러보면 사용자가 회원가입 시 우리에게 어떤 정보를 제공할지 동의 화면을 데모로 확인해볼 수 있다.

![kakao-development4](<../img/tripllo/(7)login4-vue-social-login/kakao-development4.png>)
...
![devtool-login-success](<../img/tripllo/(7)login4-vue-social-login/devtool-login-success.png>)
...
![google-development](<../img/tripllo/(7)login4-vue-social-login/google-development.png>)

프로젝트 선택을 누르고 새 프로젝트를 누른다. 프로젝트 이름을 만들자.

![google-development2](<../img/tripllo/(7)login4-vue-social-login/google-development2.png>)

API 및 서비스를 눌러서 들어가고, 또 왼쪽 탭에 사용자 인증정보를 눌러서 사용자 인증 정보를 만들자. 몇 메뉴 중에 OAuth 클라이언트 ID 를 누르자.

![google-development3](<../img/tripllo/(7)login4-vue-social-login/google-development3.png>)

그리고,

![google-development4](<../img/tripllo/(7)login4-vue-social-login/google-development4.png>)

이름을 정해주고, 승인된 리디렉션에 localhost 를 적어주자.

![google-development5](<../img/tripllo/(7)login4-vue-social-login/google-development5.png>)

이런 클라이언트 ID와 보안 비밀번호가 나온다. 잘 기록해두자. 그리고 다시 왼쪽에

![google-development6](<../img/tripllo/(7)login4-vue-social-login/google-development6.png>)
